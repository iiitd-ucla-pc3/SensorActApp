 ...
 * 
 * https://github.com/bsautner/com.nimbits/blob/master/nimbits-model/src/com/nimbits/client/model/Const.java
 * 
 * @author samy
 *
 */
...
public class Const {
	...
	public static final String URL_REPOSITORY_REGISTER_USER=URL_REPOSITORY_SERVER+"user/register";
	public static final String URL_REPOSITORY_LOGIN_USER=URL_REPOSITORY_SERVER+"user/login";
	public static final String URL_REPOSITORY_ADD_DEVICE=URL_REPOSITORY_SERVER+"device/add";
	public static final String URL_REPOSITORY_DELETE_DEVICE=URL_REPOSITORY_SERVER+"device/delete";
	public static final String URL_REPOSITORY_LIST_ALL_DEVICES=URL_REPOSITORY_SERVER+"device/list";
	public static final String URL_REPOSITORY_QUERY_DATA=URL_REPOSITORY_SERVER+"data/query";





	public static final String URL_BROKER_ADD_USER=URL_BROKER_SERVER+"registeruser";
	//public static final String URL_REPSOSITORY_ADD_DEVICE = URL_BROKER_SERVER+"adddevice";
	public static final String URL_BROKER_DELETE_DEVICE=URL_BROKER_SERVER+"deletedevice";
	public static final String URL_BROKER_QUERY_DATA=URL_REPOSITORY_SERVER+"querydata";
	...
	public static final String URL_BROKER_LIST_ALL_DEVICES =URL_BROKER_SERVER+"listalldevices";
