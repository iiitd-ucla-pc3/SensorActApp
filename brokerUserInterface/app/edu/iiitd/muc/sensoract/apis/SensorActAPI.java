...
public class SensorActAPI extends Application {
	...
	public static ListAllRepositories listAllRepositories = new ListAllRepositories();
	public static RegisterRepository registerRepository = new RegisterRepository();
